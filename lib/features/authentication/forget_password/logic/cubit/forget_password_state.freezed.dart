...
class _$ForgetPasswordErrorImpl<T> implements ForgetPasswordError<T> {
  const _$ForgetPasswordErrorImpl(this.apiErrorModel);
  ...
  @override
  String toString() {
    return 'ForgetPasswordState<$T>.forgetPasswordError(apiErrorModel: $apiErrorModel)';
  }
...
abstract class ForgetPasswordError<T> implements ForgetPasswordState<T> {
  const factory ForgetPasswordError(final ApiErrorModel apiErrorModel) =
      _$ForgetPasswordErrorImpl<T>;
